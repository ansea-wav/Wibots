...
export default function DashboardHome({ client, config, responders, botStatus }: DashboardHomeProps) {
  const stats = [
    { 
      ...
      icon: 'robot_2', 
      cardBg: 'bg-[#fdfcf7] border border-zinc-950 shadow-[4px_4px_0px_#09090b]', 
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-5">
        {stats.map((stat, i) => (
          <motion.div 
            ...
            key={i} 
            className={`rounded-3xl p-5 flex items-center gap-4 ${stat.cardBg}`}
          >
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 mt-8">
        <div className="bg-[#fdfcf7] border border-zinc-950 rounded-[2.2rem] p-6 shadow-[4px_4px_0px_#09090b] text-left">
